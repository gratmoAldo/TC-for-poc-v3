...
=end
  ...
  def backup_db
    ...
    dump_model_csv :class => ServiceRequest, :attribute_list => %w(sr_number severity status handling next_action_at site_id contact_id escalation owner_id created_at closed_at product version serial title description)
